...
SHOP_ITEMS = [
    # DANH MỤC: MÈO
    {
        ...
        "category": "Mèo",
        "price": 100000,
        "image": "assets/mèo.png"  # Ảnh mèo đốm từ Image 1
    },
    {
        "id": "cat_02",
        "name": "Mèo Lông Dài",
        "category": "Mèo",
        "price": 500000,
        "image": "assets/mèo premium.png"  # Ảnh mèo lông dài từ Image 1
    },
    ...
    # DANH MỤC: THỨC ĂN & CÁT
    {
        ...
        "price": 100,
        "image": "assets/tanh dinh dưỡng.png"
    },
    {
        "id": "food_02",
        "name": "Pate Cá Ngừ",
...
def display_item_card(item: Dict, col):
    ...
    with col:
        ...
        if owned:
            ...
            if st.button(f"{item['price']:,}", key=f"buy_{item['id']}", use_container_width=True):
                success, message = purchase_item(item)
                if success:
                    st.success(message)
                    st.rerun()  # Làm mới trang để cập nhật điểm
                else:
                    st.error(message)
